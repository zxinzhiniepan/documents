#  hibernate.cfg.xml配置文件详解
 - AUTHOR: xinzhiniepan
 - DATE: 2018-03-23 09:44

## 例子
可以在github下载对应的hibernate.cfg.xml配置(https://github.com/hibernate/hibernate-orm/blob/master/etc/hibernate.cfg.xml)
PS:对应的xml参数可以在github上查看(https://raw.githubusercontent.com/hibernate/hibernate-orm/master/etc/hibernate.properties)
该文件在hibernate.cfg.xml中的用法
```
...
...
<!DOCTYPE hibernate-configuration PUBLIC   
    ...
    <hibernate-configuration>   
      ...
      <session-factory> 
          ...
          <propertyname name="hibernate.cache.provider_class">org.hibernate.cache.EhCacheProvider</propertyname><!-- 指定缓存产品所需的类 -->
